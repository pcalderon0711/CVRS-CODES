...
% ========== COMPUTED QUANTITIES ========= %
W = @(v)myTrans(v,ts,W_rest,mySquarewave(v-ts,W_rest,W_exer));
A_pesk = @(v)myTrans(v,ts,A_pesk_rest,mySquarewave(v-ts,A_pesk_rest,A_pesk_exer));
R_p = @(v)myTrans(v,ts,R_p_rest,mySquarewave(v-ts,R_p_rest,R_p_exer));
