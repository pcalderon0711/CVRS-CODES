function [Z,V]=cvsfbtrapezpenalty(T,N,alpha,beta,flag,flag1)
...
%      is N+1
%alpha, beta ... penalty coefficients for penalty terms Q and QQ
            ...
            function varargout=gfunc(F)
                ...
                elseif flg==1
                    ...
                    G=Vtot*(al*ar*F^2-mul*mur)...
                        ...
                        +cap*(mur*(lambdal+mul*Rprest)+al*(lambdar+mur*Rs)*F)*F...
...
%             A(13,13)=-Fs(j)/VTO2;
            ...
            A(12,13)=(1/VTCO2)*(caco2-x(12,j))*dfdcvo2;
            A(13,13)=(1/VTO2)*(-Fs(j)+(cao2-x(13,j))*dfdcvo2);
