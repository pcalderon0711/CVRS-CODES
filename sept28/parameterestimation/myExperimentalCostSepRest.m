function J = myExperimentalCostSepRest(P,pas_data,params_rest,averageH_rest,paramset_idx)
...
for i=length(pas_data) % in total, there are N+1 data points, but first data point is at t=0, so we start at n=2
    J(i) = (x1(1)-pas_data(i));
end
